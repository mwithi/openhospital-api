...
/**
 * Translates Spring ApplicationEvents published by OH-core into {@link OHDomainEvents} and fans them out to all running plugins via
 * {@link PluginRegistryImpl#publishEvent}.
 *
 * <h3>How to add a new bridge</h3>
 * <ol>
 * <li>Add or find the Spring event in the relevant OH-core IoOperation (follow the pattern of PatientCreatedEvent / PatientMergedEvent).</li>
 * <li>Add an {@code @EventListener} method here that maps it to the corresponding {@link OHDomainEvents} inner class.</li>
 ...
 * </ul>
 *
 * <h3>TODO — events declared in OHDomainEvents but not yet bridged</h3> Each item below requires: (a) a Spring event record in openhospital-core (like
 * PatientCreatedEvent), and (b) a corresponding @EventListener method in this class.
 *
 * <ul>
 * <li><b>PatientUpdated</b> — publish after Patient update in PatientIoOperation. Maps to {@link OHDomainEvents.PatientUpdated}.</li>
 *
 * <li><b>PatientDeleted</b> — publish after soft-delete in PatientIoOperation. Maps to {@link OHDomainEvents.PatientDeleted}.</li>
 *
 * <li><b>PatientAdmitted</b> — publish after Admission save in AdmissionIoOperations. Maps to {@link OHDomainEvents.PatientAdmitted(admissionId, patientCode,
 * wardCode)}. wardCode is available on the Admission entity.</li>
 *
 * <li><b>PatientDischarged</b> — publish after discharge in AdmissionIoOperations. Maps to {@link OHDomainEvents.PatientDischarged(admissionId, patientCode,
 * dischargeTypeCode)}.</li>
 *
 * <li><b>LaboratoryExamCreated</b> — publish after lab exam save in LaboratoryIoOperations. Maps to {@link OHDomainEvents.LaboratoryExamCreated(examId,
 * patientCode, examCode)}.</li>
 *
 * <li><b>PluginActivated / PluginDeactivated</b> — published internally by PluginRegistryImpl itself when a plugin starts or stops. No core bridge needed.</li>
 * </ul>
 */
@Component
